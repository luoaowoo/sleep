...
- 小米手环睡眠辅助：通过 Mi Fitness、小米运动健康/小米健康（`com.mi.health`）或 Zepp Life 同步到 Health Connect；睡前开启前台鼾声检测，睡醒后用同步到的睡眠结束记录自动停录/校准。
...
1. 在 Mi Fitness、小米运动健康/小米健康（`com.mi.health`）或 Zepp Life 中开启 Health Connect 睡眠同步。
